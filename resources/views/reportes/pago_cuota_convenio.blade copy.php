                ...
                <td style="width:75%; vertical-align: top;padding-left:10px;">
                    <table width="100%" style="border-collapse: collapse; border-spacing: 0;">
                        <tr style="font-size: 11px">
                            ...
                            <td style="border: 1px solid #000; text-align:center; background-color:#D6D3D2;"><b>Interes</b></td>
                            <td style="border: 1px solid #000; text-align:center; background-color:#D6D3D2;"><b>Saldo a favor</b></td>
                            ...
                            <td style="border: 1px solid #000; text-align:center; background-color:#D6D3D2;"><b>Valor Pagado</b></td>
                            <td style="border: 1px solid #000; text-align:center; background-color:#D6D3D2;"><b>Saldo Pendiente</b></td>
