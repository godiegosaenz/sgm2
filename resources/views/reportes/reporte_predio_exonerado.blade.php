        ...
        <div style="margin-top:2px;">
            ...
            @if(isset($resultados_final) && sizeof($resultados_final)>0 ) 
                <div style="margin-top: 12px; margin-bottom: 32px;">
                    <center>
                        <span style="font-size:14px; text-align:center"><b>Analitica de Predios Urbano y Rural con Exoneraciones</b></span>
                    </center> 
            ...
            @if(isset($datos_urbano) && sizeof($datos_urbano)>0) 
                <div style="margin-top: 12px; margin-bottom: 32px;">
                    <center>
                        <span style="font-size:14px; text-align:center"><b>Analitica de Predios Urbano con Exoneraciones</b></span>
                    </center> 
                    ...
                    <table class="ltable"  border="0" width="100%" style="padding-bottom:2px !important">
                        @php
                            $cont=0;
                        @endphp
                        @foreach($listado_final_urbano as $key => $lista)
                            ...
                            <tr style="font-size: 9px !important; background-color: #D3D3D3;line-height:15px; "> 
                                ...
                                <th width="20%" style="border: 0px; text-align: center">CEDULA</th>
                                <th width="40%" style="border: 0px; ;border-color: #D3D3D3; text-align: center">CONTRIBUYENTE</th>
                            
                                <th width="30%" style="border: 0px; text-align: center">CLAVE CATASTRAL</th>
