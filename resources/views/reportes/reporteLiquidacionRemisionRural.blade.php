...
<body>
    ...
    <table class="cabecera" style="font-family: Arial;font-size:12px !important">
            <tr>
                ...
                <td class="encabezado">
                    <p style="font-size:14px !important"><b>GAD MUNICIPAL DEL CANTÓN SAN VICENTE<br> DIRECCION FINANCIERA TESORERIA
    ...
    <div class="" style="font-family: Arial; font-size:8 px;">
        <div class="">
            <center>
               
              <p style="margin: 0; padding: 0;font-size:8 px;">
                 <b>Liquidación de predios {{ $ubicacion == 1 ? 'urbanos' : 'rurales' }}</b>
             </p>

            <p style="margin: 4px 0 0 0; padding: 0;font-size:8 px;">
                <b>Fecha liquidación {{date('d/m/Y')}}</b>
            </p>
        ...
        <table class="blueTable">
                ...
                @isset($DatosLiquidacion)
                    ...
                    @foreach ($DatosLiquidacion as $key=> $data)
                        ...
                        <tfoot>
                            ...
                            @endphp
                            <tr style="font-size:11px !important;line-height:5px" style="">

                                <td  colspan="4"style="font-size:11px;border: 0px; border-color: #D3D3D3;  text-align: right;">
                                    <b></b>
                                </td>

                                <td style="border-left: 0px; border-bottom: 0px;border-center:0px;border-right:0px;; border-color:black;text-align: right; font-size:11px">
            ...
            <tfoot>
                 <tr style="font-size:11px !important;line-height:5px" style="">
                    ...
                    <td  colspan="4"style="font-size:12px;border: 0px; border-color: #D3D3D3;  text-align: right;">
                        <b>TOTALES</b>
                    </td>

                    <td style="border-left: 0px; border-bottom: 0px;border-center:0px;border-right:0px;border-top:0px;text-align: right; font-size:11px">
                    ...
                    <td style="border-left: 0px; border-bottom: 0px;border-center:0px;border-right:0px;border-top:0pxk;text-align: right; font-size:11px">
