...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="propietario_nombre" class="col-md-4 col-form-label fw-bold">Propietario</label>
                            <div class="col-md-8">
                                <select id="cmb_propietario" name="cmb_propietario"
                                    class="col-md-4 col-form-label fw-bold form-control" style="width: 100%;"
                                    data-bs-theme="dark" onchange="cargaInfoContribuyente()">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control form-control-sm" id="ruc_cedula" maxlength="13"
                                    disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="razon_social" class="col-md-4 col-form-label fw-bold">Contribuyente/Razon
                                Social</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control form-control-sm" id="razon_social" maxlength="255"
                                    disabled>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="propietario_nombre" class="col-md-4 col-form-label fw-bold">N° de
                        ...
                        <div class="row mb-3">
                            <label for="tipo_contribuyente" class="col-md-4 col-form-label fw-bold">Tipo de
                                contribuyente</label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label for="tipo_contribuyente" class="col-md-4 col-form-label fw-bold">Obligado
                                Contabilidad</label>
                            <div class="col-md-8">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="row mb-3">
                            <label for="representante_legal" class="col-md-4 col-form-label fw-bold">Rep. legal
                                (sociedades)</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control form-control-sm" id="representante_legal"
                                    maxlength="255" disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="cedula_representante" class="col-md-4 col-form-label fw-bold">Cédula del Rep.
                                Legal</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control form-control-sm" id="cedula_representante"
                                    maxlength="13" disabled>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="inicio_actividades" class="col-md-4 col-form-label fw-bold">Inicio de
                                Actividades</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control form-control-sm" id="inicio_actividades"
                                    maxlength="255" disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="estado_contribuyente" class="col-md-4 col-form-label fw-bold">Estado de
                                contribuyente</label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label for="clase_contribuyente" class="col-md-4 col-form-label fw-bold">Clase de
                                contribuyente</label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control form-control-sm" id="artesano_cont" value="Si"
                                    disabled>
                            </div>
                            <div class="col-md-1">
                        ...
                        <tbody>
                            @if(old('locales'))
                                @foreach(old('locales') as $key => $local)
                                    <td>
                                        <input class="form-check-input checkbox-grande" type="checkbox" name="locales[{{$key}}][id]"
                                            value="{{ $key }}" {{ old("locales.$key.id") ? 'checked' : '' }}>
                                    </td>
                                    <td>
                                        <input type="hidden" name="locales[{{$key}}][local_descripcion]"
                                            value="{{ $local['local_descripcion'] }}">
                                    ...
                                    <td>
                                        <input type="hidden" name="locales[{{$key}}][local_propio]"
                                            value="{{ $local['local_propio'] }}">
                                        {{ $local['local_propio'] }}
                                    </td>
                                    <td>
                                        <input type="hidden" name="locales[{{$key}}][local_propio]"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select {{$errors->has('year_declaracion') ? 'is-invalid' : ''}}"
                        id="year_declaracion" name="year_declaracion">
                        <option value="">Seleccione</option>
                        @foreach ($PsqlYearDeclaracion as $year)
                            <option value="{{$year->id}}" {{ old('year_declaracion') == $year->id ? 'selected' : '' }}>
                                {{$year->year_declaracion . ' >> Periodo Fiscal ' . $year->year_ejercicio_fiscal}}</option>
                        @endforeach
                    </select>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control {{$errors->has('fecha_declaracion') ? 'is-invalid' : ''}}"
                        id="fecha_declaracion" name="fecha_declaracion" value="{{old('fecha_declaracion')}}">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    <div class="form-check" style="display: none;">
                        <input class="form-check-input checkbox-grande" type="checkbox" id="lleva_contabilidad"
                            name="lleva_contabilidad" value="1" {{ old('lleva_contabilidad') ? 'checked' : '' }}>
                        <label class="form-check-label" for="lleva_contabilidad">Lleva Contabilidad</label>


                    </div>
                    <div class="form-check">
                        <input class="form-check-input checkbox-grande" type="checkbox" id="profesionales"
                            name="profesionales" value="1" {{ old('profesionales') ? 'checked' : '' }}>
                        <label class="form-check-label" for="profesionales">Profesionales (Sin valores declarados en el
                            periodo)</label>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <fieldset class="border p-3 bg-custom">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('act_caja_banco') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad"
                                        id="act_caja_banco" name="act_caja_banco" value="{{old('act_caja_banco')}}"
                                        onblur="sumarValores('obligado_contabilidad', 'act_total_activos')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('act_ctas_cobrar') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad"
                                        id="act_ctas_cobrar" name="act_ctas_cobrar" value="{{old('act_ctas_cobrar')}}"
                                        onblur="sumarValores('obligado_contabilidad', 'act_total_activos')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('act_inv_mercaderia') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad"
                                        id="act_inv_mercaderia" name="act_inv_mercaderia"
                                        value="{{old('act_inv_mercaderia')}}"
                                        onblur="sumarValores('obligado_contabilidad', 'act_total_activos')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <label for="act_vehiculo_maquinaria" class="col-sm-7 col-form-label">Vehículos y
                                Maquinaria</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('act_vehiculo_maquinaria') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad"
                                        id="act_vehiculo_maquinaria" name="act_vehiculo_maquinaria"
                                        value="{{old('act_vehiculo_maquinaria')}}"
                                        onblur="sumarValores('obligado_contabilidad', 'act_total_activos')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('act_equipos_oficinas') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad"
                                        id="act_equipos_oficinas" name="act_equipos_oficinas"
                                        value="{{old('act_equipos_oficinas')}}"
                                        onblur="sumarValores('obligado_contabilidad', 'act_total_activos')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('act_edificios_locales') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad"
                                        id="act_edificios_locales" name="act_edificios_locales"
                                        value="{{old('act_edificios_locales')}}"
                                        onblur="sumarValores('obligado_contabilidad', 'act_total_activos')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('act_terrenos') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad"
                                        id="act_terrenos" name="act_terrenos" value="{{old('act_terrenos')}}"
                                        onblur="sumarValores('obligado_contabilidad', 'act_total_activos')">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <button class="btn btn-outline-secondary" type="button"
                                        onclick="sumarValores('obligado_contabilidad', 'act_total_activos')">+</button>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('act_total_activos') ? 'is-invalid' : ''}} input-decimales totales_pasivos_activos"
                                        id="act_total_activos" name="act_total_activos"
                                        value="{{old('act_total_activos')}}">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 mb-3">
                    <fieldset class="border p-3 bg-custom">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('pas_ctas_dctos_pagar') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad_pasivos"
                                        id="pas_ctas_dctos_pagar" name="pas_ctas_dctos_pagar"
                                        value="{{old('pas_ctas_dctos_pagar')}}"
                                        onblur="sumarValores('obligado_contabilidad_pasivos', 'pas_total_pasivos')">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="pas_obligaciones_financieras" class="col-sm-7 col-form-label">Obligaciones
                                Financieras</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('pas_obligaciones_financieras') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad_pasivos"
                                        id="pas_obligaciones_financieras" name="pas_obligaciones_financieras"
                        ...
                        <div class="mb-3 row">
                            <label for="pas_otras_ctas_pagar" class=" col-sm-7 col-form-label">Otras Cuentas por
                                Pagar</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('pas_otras_ctas_pagar') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad_pasivos"
                                        id="pas_otras_ctas_pagar" name="pas_otras_ctas_pagar"
                                        value="{{old('pas_otras_ctas_pagar')}}"
                                        onblur="sumarValores('obligado_contabilidad_pasivos', 'pas_total_pasivos')">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('pas_otros_pasivos') ? 'is-invalid' : ''}} input-decimales obligado_contabilidad_pasivos"
                                        id="pas_otros_pasivos" name="pas_otros_pasivos" value="{{old('pas_otros_pasivos')}}"
                                        onblur="sumarValores('obligado_contabilidad_pasivos', 'pas_total_pasivos')">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <button type="button" class=" btn btn-outline-secondary"
                                        onclick="sumarValores('obligado_contabilidad_pasivos', 'pas_total_pasivos')">+</button>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('pas_total_pasivos') ? 'is-invalid' : ''}} input-decimales totales_pasivos_activos"
                                        id="pas_total_pasivos" name="pas_total_pasivos"
                                        value="{{old('pas_total_pasivos')}}">
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset class="border p-3 mb-4">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <button type="button" class="btn btn-outline-secondary"
                                        onclick="restarValores('totales_pasivos_activos', 'patrimonio_total')">=</button>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('patrimonio_total') ? 'is-invalid' : ''}} input-decimales totales_pasivos_activos"
                                        id="patrimonio_total" name="patrimonio_total" value="{{old('patrimonio_total')}}">
                                </div>
                            </div>
                        </div>
                    </fieldset>
        ...
        <fieldset class="border p-3 mb-4 " id="obligados_fieldset" style="display:none;">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <fieldset class="border p-3 bg-custom">
                        <legend class="w-auto">
                            <h5>Patente Municipal</h5>
                        </legend>

                        <div class="mb-3 row">
                            <label for="act_inv_mercaderia" class="col-sm-6 col-form-label">% de ingresos percibidos en el
                                Canton</label>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    <button class="btn btn-outline-secondary" type="button" id="button-addon33">%</button>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_total_percibidos_sv') ? 'is-invalid' : ''}}"
                                        id="cont_total_percibidos_sv" name="cont_total_percibidos_sv"
                                        value="{{old('cont_total_percibidos_sv')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_total_activos') ? 'is-invalid' : ''}} input-decimales cont_pasivos_activos"
                                        id="cont_total_activos" name="cont_total_activos"
                                        value="{{old('cont_total_activos')}}"
                                        onblur="restarValores('cont_pasivos_activos', 'cont_total_patrimonio')">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_total_pasivos') ? 'is-invalid' : ''}} input-decimales cont_pasivos_activos"
                                        name="cont_total_pasivos" id="cont_total_pasivos"
                                        value="{{old('cont_total_pasivos')}}"
                                        onblur="restarValores('cont_pasivos_activos', 'cont_total_patrimonio')">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    <button class="btn btn-outline-secondary" type="button" id="button-addon2"
                                        onclick="restarValores('cont_pasivos_activos', 'cont_total_patrimonio')">=</button>
                                    <input type="number"
                                        class=" desabilita_txt form-control {{$errors->has('cont_total_patrimonio') ? 'is-invalid' : ''}} input-decimales"
                                        id="cont_total_patrimonio" name="cont_total_patrimonio"
                                        value="{{old('cont_total_patrimonio')}}" aria-label="Example text with button addon"
                        ...
                        <div class="col-sm-9" style="display: none;">
                            <div class="form-check">
                                <input class="form-check-input checkbox-grande" type="checkbox" id="calcula_patente"
                                    name="calcula_patente" value="1" {{ old('calcula_patente') ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    <fieldset class="border p-3 bg-custom">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('total_activo15') ? 'is-invalid' : ''}} input-decimales total_activo15"
                                        name="total_activo15" id="total_activo15" value="{{old('total_activo15')}}"
                                        onblur="calcularBI()">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <label for="cont_total_pasivos_corriente" class="col-sm-6 col-form-label">Pasivo
                                Corriente</label>
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_total_pasivos_corriente') ? 'is-invalid' : ''}} input-decimales cont_total_pasivos_corriente"
                                        name="cont_total_pasivos_corriente" id="cont_total_pasivos_corriente"
                                        value="{{old('cont_total_pasivos_corriente')}}" onblur="calcularBI()">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    <button class="btn btn-outline-secondary" type="button" id="button-addon2"
                                        onclick="restarValores('cont_total_pasivos_corriente', 'cont_total_bi_act_total')">=</button>
                                    <input type="number"
                                        class=" desabilita_txt form-control {{$errors->has('cont_total_bi_act_total') ? 'is-invalid' : ''}} input-decimales"
                                        id="cont_total_bi_act_total" name="cont_total_bi_act_total"
                                        value="{{old('cont_total_bi_act_total')}}"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input checkbox-grande" type="checkbox" id="impuesto_1punto5"
                                        name="impuesto_1punto5" value="1" {{ old('impuesto_1punto5') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="impuesto_1punto5">Impuesto Anual del 1.5 por mil
                                        sobre los activos totales</label>
                ...
                <div class="col-md-12 mb-3">
                    <fieldset class="border p-3 bg-custom">
                        ...
                        <div class="mb-3 row">
                            <label for="cont_total_patrimonio" class="col-sm-3 col-form-label"
                                style="text-align: last;">Cargar Documentos</label>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">

                                    <input type="file"
                                        class=" desabilita_txt form-control {{$errors->has('archivo_patente') ? 'is-invalid' : ''}} input-decimales"
                                        id="archivo_patente" name="archivo_patente" value="{{old('archivo_patente')}}"
                                        aria-label="Example text with button addon" aria-describedby="button-addon2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <label for="cont_form_sri" class="col-sm-3 col-form-label" style="text-align: last;">Formulario
                                SRI (No.)</label>
                            <div class="col-sm-6">
                                <input type="number"
                                    class="desabilita_txt form-control {{$errors->has('cont_form_sri') ? 'is-invalid' : ''}}"
                                    id="cont_form_sri" name="cont_form_sri" value="{{old('cont_form_sri')}}">
                            </div>
                        </div>

                        <div class="mb-3 row">
                            <label for="act_inv_mercaderia" class="col-sm-3 col-form-label"
                                style="text-align: last;">Original/sustitutiva</label>
                            <div class="col-sm-6">
                                <select
                                    class="desabilita_txt form-select {{$errors->has('cont_original') ? 'is-invalid' : ''}}"
                                    id="cont_original" name="cont_original">
                                    <option value="">Seleccione</option>
                                    <option value="1" {{ old('cont_original') == '1' ? 'selected' : '' }}>Original</option>
                                    <option value="2" {{ old('cont_original') == '2' ? 'selected' : '' }}>Sustitutiva</option>
                                </select>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_impuesto') ? 'is-invalid' : ''}} input-decimales cont_patente_muni"
                                        name="cont_impuesto" id="cont_impuesto" value="{{old('cont_impuesto')}}"
                                        onblur="sumarValores('cont_patente_muni', 'cont_pago_patente')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_exoneracion') ? 'is-invalid' : ''}} input-decimales cont_patente_muni"
                                        name="cont_exoneracion" id="cont_exoneracion" value="{{old('cont_exoneracion')}}"
                                        onblur="sumarValores('cont_patente_muni', 'cont_pago_patente')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_sta') ? 'is-invalid' : ''}} input-decimales cont_patente_muni"
                                        name="cont_sta" id="cont_sta" value="{{old('cont_sta')}}"
                                        onblur="sumarValores('cont_patente_muni', 'cont_pago_patente')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_intereses') ? 'is-invalid' : ''}} input-decimales cont_patente_muni"
                                        name="cont_intereses" id="cont_intereses" value="{{old('cont_intereses')}}"
                                        onblur="sumarValores('cont_patente_muni', 'cont_pago_patente')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_recargos') ? 'is-invalid' : ''}} input-decimales cont_patente_muni"
                                        name="cont_recargos" id="cont_recargos" value="{{old('cont_recargos')}}"
                                        onblur="sumarValores('cont_patente_muni', 'cont_pago_patente')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <button class="btn btn-outline-secondary" type="button" id="button-addon2"
                                        onclick="sumarValores('cont_patente_muni', 'cont_pago_patente')">=</button>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_pago_patente') ? 'is-invalid' : ''}} input-decimales cont_patente_muni"
                                        name="cont_pago_patente" id="cont_pago_patente" value="{{old('cont_pago_patente')}}"
                                        aria-label="Example text with button addon" aria-describedby="button-addon2"
                                        readonly>
                                </div>
                            </div>
            ...
            <fieldset class="col-md-6 border p-3 mb-4" id="patente_fieldset1">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_impuesto_act') ? 'is-invalid' : ''}} input-decimales cont_pago_acti"
                                        name="cont_impuesto_act" id="cont_impuesto_act" value="{{old('cont_impuesto_act')}}"
                                        onblur="sumarValores('cont_pago_acti', 'cont_pago_activo_total')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_exoneracion_act') ? 'is-invalid' : ''}} input-decimales cont_pago_acti"
                                        name="cont_exoneracion_act" id="cont_exoneracion_act"
                                        value="{{old('cont_exoneracion_act')}}"
                                        onblur="sumarValores('cont_pago_acti', 'cont_pago_activo_total')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <label for="cont_sta_act" class="col-sm-6 col-form-label">Servicio Técnico
                                Administrativo</label>
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_sta_act') ? 'is-invalid' : ''}} input-decimales cont_pago_acti"
                                        name="cont_sta_act" id="cont_sta_act" value="{{old('cont_sta_act')}}"
                                        onblur="sumarValores('cont_pago_acti', 'cont_pago_activo_total')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_intereses_act') ? 'is-invalid' : ''}} input-decimales cont_pago_acti"
                                        name="cont_intereses_act" id="cont_intereses_act"
                                        value="{{old('cont_intereses_act')}}"
                                        onblur="sumarValores('cont_pago_acti', 'cont_pago_activo_total')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_recargos_act') ? 'is-invalid' : ''}} input-decimales cont_pago_acti"
                                        name="cont_recargos_act" id="cont_recargos_act" value="{{old('cont_recargos_act')}}"
                                        onblur="sumarValores('cont_pago_acti', 'cont_pago_activo_total')" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <button class="btn btn-outline-secondary" type="button" id="button-addon2"
                                        onclick="sumarValores('cont_pago_acti', 'cont_pago_activo_total')">=</button>
                                    <input type="number"
                                        class="desabilita_txt form-control {{$errors->has('cont_pago_activo_total') ? 'is-invalid' : ''}} input-decimales cont_pago_acti"
                                        name="cont_pago_activo_total" id="cont_pago_activo_total"
                                        value="{{old('cont_pago_activo_total')}}"
                                        aria-label="Example text with button addon" aria-describedby="button-addon2"
                                        readonly>
                                </div>
                            </div>
            ...
            <fieldset class="col-md-12 border p-3 mb-4" id="patente_fieldset1">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="mb-3 row">
                            <label for="cont_impuesto_act" class="col-sm-3 col-form-label" style="text-align: right;">Total
                                a Pagar</label>
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="desabilita_txt form-control " name="total_final"
                                        id="total_final" value="" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalContribuyente" tabindex="-1" aria-labelledby="ContribuyenteModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <center>
                        ...
                        <a href="" id="vinculo"><button type="button" id="descargar" class="btn btn-primary"><i
                                    class="fa fa-mail"></i> Descargar</button> </a>
                    </center>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" class="desabilita_txt form-control" name="provincia_local"
                                                id="provincia_local" value="{{old('provincia_local')}}" value="Manabi">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" class="desabilita_txt form-control" name="canton_local"
                                                id="canton_local" value="{{old('canton_local')}}" value="San Vicente">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <select class="form-select {{$errors->has('parroquia_id') ? 'is-invalid' : ''}}"
                                                id="parroquia_id" name="parroquia_id" required>
                                                <option value="" id="optionSelectParroquia">Seleccione una parroquia
                                                </option>
                                                @if(old('canton_id'))
                                ...
                                <div class="mb-3 row">
                                    <label for="callep_local" class="col-sm-3 col-form-label" style="text-align: end;">Calle
                                        Principal</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" class="desabilita_txt form-control" name="callep_local"
                                                id="callep_local" value="{{old('callep_local')}}">
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-3 row">
                                    <label for="calles_local" class="col-sm-3 col-form-label" style="text-align: end;">Calle
                                        Secundaria</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" class="desabilita_txt form-control" name="calles_local"
                                                id="calles_local" value="{{old('calles_local')}}">
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-3 row">
                                    <label for="referencia_local" class="col-sm-3 col-form-label"
                                        style="text-align: end;">Referencia Ubicacion</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" class="desabilita_txt form-control" name="referencia_local"
                                                id="referencia_local" value="{{old('referencia_local')}}">
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-3 row">
                                    <label for="ncomercial_local" class="col-sm-3 col-form-label"
                                        style="text-align: end;">Nombre Comercial</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" class="desabilita_txt form-control" name="ncomercial_local"
                                                id="ncomercial_local" value="{{old('ncomercial_local')}}">
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-3 row">
                                    <label for="estado_local" class="col-sm-3 col-form-label"
                                        style="text-align: end;">Estado</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <select
                                                class="form-select {{$errors->has('estado_establecimiento_id') ? 'is-invalid' : ''}}"
                                                id="estado_establecimiento_id" name="estado_establecimiento_id" required>
                                ...
                                <div class="mb-3 row">
                                    <label for="tipo_local" class="col-sm-3 col-form-label"
                                        style="text-align: end;">Local</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <select
                                                class="form-select {{$errors->has('estado_establecimiento_id') ? 'is-invalid' : ''}}"
                                                id="tipo_local" name="tipo_local" required>
                                                <option value="">Seleccione un tipo</option>
                                                <option value="1" {{ old('tipo_local') == '1' ? 'selected' : '' }}>Propio
                                                </option>
                                                <option value="2" {{ old('tipo_local') == '2' ? 'selected' : '' }}>Arrendado
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="mb-3 row">
                                    <label for="cmb_actividad" class="col-sm-3 col-form-label"
                                        style="text-align: end;">Actividad</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <select id="cmb_actividad" name="cmb_actividad"
                                                class="col-md-4 col-form-label fw-bold form-control modal_act"
                                                style="width: 100%;" data-bs-theme="dark" onchange="cargaInfoActividad()">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    <label for="codigo_act" class="col-sm-3 col-form-label"
                                        style="text-align: end;">Codigo</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" class="desabilita_txt form-control modal_act"
                                                name="codigo_act" id="codigo_act" value="{{old('codigo_act')}}">
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-3 row">
                                    <label for="descripcion_act" class="col-sm-3 col-form-label"
                                        style="text-align: end;">Descripcion</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <textarea class="desabilita_txt form-control modal_act" name="descripcion_act"
                                                id="descripcion_act" value="{{old('descripcion_act')}}" rows="6"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select modal_new_cont" id="tipo_persona_new"
                                            name="tipo_persona_new" onchange="cambioTipoPersona()">
                                            <option value="">Seleccione un tipo</option>
                                            <option value="1" {{ old('tipo_contribuyente_id') == '1' ? 'selected' : '' }}>
                                                Persona natural</option>
                                            <option value="2" {{ old('tipo_contribuyente_id') == '2' ? 'selected' : '' }}>
                                                Sociedades</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="cmb_ruc" id="cmb_ruc"
                                            onblur="BuscaContribuyente()">

                                    </div>

                                    <div class="mb-3">
                                        <label for="contribuyente" class="form-label">Contribuyente</label>
                                        <input type="text" class="form-control modal_new_cont" name="contribuyente"
                                            id="contribuyente" value="{{old('contribuyente')}}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="fecha_nacimiento" class="form-label">Fecha Nacimiento</label>
                                        <input type="date" class="form-control modal_new_cont" name="fecha_nacimiento"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="cmb_ruc_rep" id="cmb_ruc_rep"
                                            onblur="BuscaContribuyenteRL()">
                                    </div>

                                    <div class="mb-3">
                                        <label for="representante" class="form-label">Repres. Legal</label>
                                        <input type="text" class="form-control modal_new_cont" name="representante"
                                            id="representante" value="{{old('representante')}}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="provincia" class="form-label">Provincia</label>
                                        <select class="form-select modal_new_cont" id="provincia" name="provincia"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select modal_new_cont" id="canton_id" name="canton_id"
                                            onchange="seleccionaParroquia()">
                                    ...
                                    <div class="mb-3">
                                        <label for="parroquia_id_" class="form-label">Parroquia</label>
                                        <div class="d-flex align-items-center gap-2">
                                            <select class="form-select modal_new_cont w-95" id="parroquia_id_"
                                                name="parroquia_id_" required>
                                                <option value="">Seleccione una Parroquia</option>
                                            </select>
                                            <button type="button" class="btn btn-success btn-sm"
                                                onclick="abrirModalParroquia()">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control modal_new_cont" name="direccion"
                                            id="direccion">{{ old('descripcion_act') }}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control modal_new_cont" name="correo" id="correo"
                                            value="{{old('correo')}}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="telefono" class="form-label">Teléfono</label>
                                        <input type="text" class="form-control modal_new_cont" name="telefono" id="telefono"
                                            value="{{old('telefono')}}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input modal_new_cont" type="checkbox"
                                                id="obligado_contabilidad" name="obligado_contabilidad" value="1" {{ old('obligado_contabilidad') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="obligado_contabilidad">Obligado a llevar
                                                contabilidad</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input modal_new_cont" type="checkbox" id="es_artesano"
                                                name="es_artesano" value="1" {{ old('es_artesano') ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control modal_new_cont" name="doc_artesano"
                                            id="doc_artesano">
                                    </div>

                                    <div class="mb-3">
                                        <label for="doc_artesano" class="form-label">Fecha de Inicio Actividades</label>
                                        <input type="date" class="form-control modal_new_cont" name="fecha_inicio_act"
                                            id="fecha_inicio_act">
                                    </div>

                                    <div class="mb-3">
                                        <label for="doc_artesano" class="form-label">Fecha de Reinicio Actividades</label>
                                        <input type="date" class="form-control modal_new_cont" name="fecha_reinicio_act"
                                            id="fecha_reinicio_act">
                                    </div>

                                    <div class="mb-3">
                                        <label for="doc_artesano" class="form-label">Fecha de Actualizacion
                                            Actividades</label>
                                        <input type="date" class="form-control modal_new_cont"
                                            name="fecha_actualizacion_act" id="fecha_actualizacion_act">
                                    </div>

                                    <div class="mb-3">
                                        <label for="doc_artesano" class="form-label">Fecha de Suspension Actividades</label>
                                        <input type="date" class="form-control modal_new_cont" name="fecha_suspension_act"
                                            id="fecha_suspension_act">
                                    </div>

                                    <div class="mb-3">
                                        <label for="doc_artesano" class="form-label">Regimen</label>
                                        <select
                                            class="modal_new_cont form-select {{$errors->has('clase_contribuyente_id') ? 'is-invalid' : ''}}"
                                            id="clase_contribuyente_id" name="clase_contribuyente_id" required>
                    ...
                    <form method="POST" action="" id="form_base">
                        ...
                        <div class="col-md-12" style="margin-top: 10px;">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7">
                                    <input type="number" step="0.01" class="form-control" id="impuesto_fracion"
                                        name="impuesto_fracion" required>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modalNuevaParroquia" tabindex="-1" >
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
