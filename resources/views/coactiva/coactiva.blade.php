...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h4 class="h2">Emisiones Coactivar</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <button type="button" class="btn btn-danger botones" rel="noopener noreferrer" onclick="verDetalle()" disabled> 
                        <i class="bi bi-pencil-square"></i> Coactivar
                    </button>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="tableUrbana" style="width: 100%">
                        <thead>
                            ...
                            <th>Observacion</th>
                            <th scope="col">Datos Notificacion</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalContribuyenteLabel">Coactivar Titulos</h5>
                    <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                </div>
                <form class="" action="" id="formCoactivar" name="formCoactivar" method="post" enctype="multipart/form-data">
                @csrf
     ...
     <div class="modal fade" id="modalDetalle" tabindex="-1" aria-labelledby="ContribuyenteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="nav nav-pills nav-stacked"style="margin-left:10px">
                                    <li style="border-color: white"><a><i class="fa fa-home text-blue"></i> <b class="text-black1" style="font-weight: 650 !important">Fecha Notificacion</b>: <span  id="fecha_notifica"></span></a></li>
                                    ...
                                    <table class="table table-bordered table-hover" id="tablaDetalleDeudas" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Valor Notificacion</th>
                ...
                <div class="modal-footer">
                     <form class="" action="" id="formCoactivarEmi" name="formCoactivarEmi" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="text" name="id_coact" id="id_coact">
                        <button type="submit" class="btn btn-success" >Generar Coactiva</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                    </form>
                </div>
            </div>
...
<script src="{{ asset('js/coactiva/emisiones_urbana.js?v='.rand())}}"></script>
