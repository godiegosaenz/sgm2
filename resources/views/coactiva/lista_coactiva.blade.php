                            ...
                            <div class="col-md-12">
                                <form class=""
                                        ...
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-md-7">
                                                <input type="date" class="form-control txt_conv_ cal_mensual"name="f_ini" id="f_ini" readonly>
                                        ...
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-md-7">
                                                <input type="date" class="form-control txt_conv cal_mensual"name="f_fin" id="f_fin" readonly>
