                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="inputCedulaPersona" type="text" class="form-control {{$errors->has('persona_id') ? 'is-invalid' : ''}}" placeholder="" aria-label="Example text with button addon" aria-describedby="buttonModalPersona" value="{{old('persona_cedula',$Cita->persona->cedula)}}" disabled>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control {{$errors->has('persona_id') ? 'is-invalid' : ''}}" id="inputNombresPersona" name="inputNombresPersona" value="{{old('persona_name',$Cita->persona->nombres.' '.$Cita->persona->apellidos)}}" disabled>
                                <div class="invalid-feedback">
                                    @if($errors->has('persona_id'))
                                        {{$errors->first('persona_id')}}
                                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="inputCedulaEspecialista" type="text" class="form-control {{$errors->has('especialista_id') ? 'is-invalid' : ''}}" placeholder="" aria-label="Example text with button addon" aria-describedby="buttonModalEspecialista" value="{{ old('especialista_cedula',$Cita->especialista->persona->cedula) }}" disabled>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control {{$errors->has('especialista_id') ? 'is-invalid' : ''}}" id="inputNombresEspecialista" name="inputNombresEspecialista" value="{{ old('especialista_name',$Cita->especialista->persona->nombres.' '.$Cita->especialista->persona->apellidos) }}" disabled>
                                <div class="invalid-feedback">
                                    @if($errors->has('especialista_id'))
                                        {{$errors->first('especialista_id')}}
                                    @endif
