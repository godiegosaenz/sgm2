...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h4 class="h2">Emision Titulos Prediales</h4>
    ...
    <form id="formConsulta" action="{{'tituloscoactivarural'}}" method="post">
        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col-3">
                <div class="mb-3">
                    <label for="num_predio">* Predio: </label>
                                    ...
                                    <table class="table table-bordered table-hover"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Terreno</th>
                                                <th>Construccion</th>
                                                <th>Otras Inversiones</th>
                                                <th>Valor Propiedad</th>
                                                <th>Rebaja Hipotecaria</th>
...
<script>
    ...
    function verificarSeleccionCasillas(){
        let formData2 = new FormData(formEmision);
        if(formData2.getAll("checkPredio[]").length > 0)
        {
            return true;
        }
        else
...
<script src="{{ asset('js/emision_predial/emitir_nuevo.js?v='.rand())}}"></script>
<script>
      cambiaLugar()
</script>
@endpush
