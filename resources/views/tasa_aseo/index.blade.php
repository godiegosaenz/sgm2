...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h4 class="h2">Tasa Aseo y Recoleccion de Desechos</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalContribuyenteLabel">
                        Liquidaciones de la Tasa de Aseo y Recoleccion de Desechos
                    </h5>
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="predios_totales_detalle">
                                <form class=""
                                    action=""
                                    id="formAseo"
                                    name="formAseo"
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <table class="table table-bordered table-hover"
                                            ...
                                            <tbody id="tbodyPrediosDetalle"></tbody>
                                        </table>
                                        <center>
                                            <button type="button" class="btn btn-sm btn-success" onclick="prediosSeleccionados()">Seleccionar</button>
                                        </center>
                                    </div>
                                </form>
                            </div>

                            <div id="listar_liquidaciones" style="display:none">
                                <form class=""
                                    action=""
                                    id="formAseoListado"
                                    name="formAseoListado"
                                    method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-12 mt-3">
                                        <table class="table table-bordered table-hover"
                                            id="tableListadoDeudaAseo"
                                            style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th><center>
                                                        <input type="checkbox" id="selectAllDeudaAseo">
                                                    </center></th>
                                                    <th>Matricula</th>
                                                    <th>Num Titulo</th>
                                            ...
                                            <tbody id="tbodyDetalleAseo"></tbody>
                                        </table>
                                    </div>
                            ...
                            <div id="listar_liquidaciones_parcial" style="display:none">
                                <form class=""
                                    action=""
                                    id="formAseoListadoParcial"
                                    name="formAseoListadoParcial"
                                    method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-12 mt-3">
                                        <table class="table table-bordered table-hover"
                                            id="tableListadoDeudaAseoParcial"
                                            style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th><center>
                                                        <input type="checkbox" id="selectAllListadoParcial">
                                                    </center></th>
                                                    <th>Matricula</th>
                                                    <th>Num Titulo</th>
                                                    <th>Uso Suelo</th>
                                            ...
                                            <tbody id="tbodyDetalleAseoParcial"></tbody>
                                        </table>
                                    </div>
...
<script>
    ...
    var formAseo = document.getElementById('formAseo');
    function verificarSeleccionCasillas(){
        let formData2 = new FormData(formAseo);
...
<script src="{{ asset('js/tasa_aseo/recaudar.js?v='.rand())}}"></script>
