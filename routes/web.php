...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('certificaciones-transito', [TransitoImpuestoCertificacionController::class, 'index'])->name('index.transito-cert');;
    ...
    //new liquidacion
    Route::get('consulta-liquidacion', [LiquidacionesController::class, 'index'])->name('index.liquidacion');
    Route::post('buscar-deudas-contribuyente', [LiquidacionesController::class, 'buscarDeudaPredio']);
    Route::get('buscar-liquidacion-rurales/{cedula}', [LiquidacionesController::class, 'consultarTitulos']);
    ...
    Route::get('detalle-convenio/{id}', [CoactivaController::class, 'detalleConvenio']);

    Route::get('imprimir-detalle-convenio/{id}/{cont}', [CoactivaController::class, 'imprimirDetalleConvenio']);
    ...
    Route::get('pdf-pago-convenio/{idcuota}/{lugar}/{coact_not}', [ConvenioPagoController::class, 'pdfPagoCuota']);
    Route::get('cuota-titulo/{idcuota}', [ConvenioPagoController::class, 'cuotaTitulo']);
