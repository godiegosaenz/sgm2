...
@Named
@ViewScoped
public class RealizarInformeOT extends BpmManageBeanBaseRoot implements Serializable {
    ...
    /**
     * Verifica si se ingresaron al menos un archivo, si es así muestra el
     * dialog de ingreso de observaciones, caso contrario no.
     * 
     * @param b 
     */
    ...
    /**
     * Termina la tarea y sube los archivos a Alfresco.
     * 
     */
    ...
    /**
     * Permite subir un archivo al sistema para subirlo posteriormente a Alfresco
     * guardando su referencia previamente.
     * 
     * @param event 
     */
    ...
    /**
     * Remueve un archivo de la lista de archivos que se van a subir al sistema.
     * 
     * @param file 
     */
