...
@Named
@ViewScoped
public class NormasConstruccion implements Serializable {
    ...
    protected Long tipoNorma;
    protected Long idTipoNorma;
    protected Long idCiudadela;
    protected Integer codigo;
    protected String proceso;
    protected String retiros;
    protected Boolean normaTipo = false;
    protected Boolean esProceso = false;
    ...
    /**
     * evento de inicio de parametros
     */
    ...
    public void initView() {
        ...
        if (idCiudadela != null) {
            ciudadela = normasServices.getCatCiudadelaById(idCiudadela);
            normaConstruccion.setIdCiudadela(ciudadela);
        }
        if (tipoNorma != null) {
            normaConstruccion.setTipoNorma(normasServices.getCatNormasConstruccionTipoById(tipoNorma));
        }
        esProceso = proceso != null;
//         else {
...
//        }
    ...
    /**
     * Agrega el nombre del Retiro o aumento dependiendo de código.
     *
     * @param cod Código del retiro o aumento
     */
    ...
    /**
     * Agrega a la lista de retiros o aumentos dependiendo del código.
     */
    ...
    /**
     * Elimina de la lista el un retiro o aumento por codigo del mismo.
     *
     * @param ra CatNormasConstruccionHasRetirosAumento
     */
    ...
    /**
     * Agrega la imagen que es subida a la norma de cosntrucción.
     *
     * @param event FileUploadEvent evento del componente de primefaces
     */
    public void handleFileUpload(FileUploadEvent event) {
        try {
            InputStream fi = event.getFile().getInputstream();
            ...
            Logger.getLogger(NormasConstruccion.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    /**
     * Realiza las diferente validaciones de ingreso y envia a guardar la norma
     * de Construcción.
     */
    public void guadarNormaConstruccion() {
        if (normaConstruccion.getTipoNorma() == null) {
            JsfUti.messageInfo(null, "Tipo norma es obligatiro.", "");
            return;
        }
        if (!normaTipo) {
            if (ciudadela == null) {
                JsfUti.messageInfo(null, "La ciudadela es Obligatorio.", "");
                return;
            }
        }
        ...
        normaConstruccion.setEstado("A");
        normaConstruccion.setSecuencia(new BigInteger("1"));
        normaConstruccion.setIdCiudadela(ciudadela);

        normaConstruccion = normasServices.guardarNormasConstrauccion(normaConstruccion, listaNormas);
        if (normaConstruccion != null) {
            if (proceso != null) {
                session.setTaskID(proceso);
                JsfUti.redirectFaces("/faces/vistaprocesos/edificaciones/normasConstruccion/solicitudNormasConstruccion.xhtml?isEspecial="
                        + normaConstruccion.getTipoNorma().getIsEspecial() + "&idNuevaNorma=" + normaConstruccion.getId());
            } else {
    ...
    /**
     * Filta los registros de CatNormasConstruccionTipo por el tipo de norma.
     * 
     * @return Lista de CatNormasConstruccionTipo.
     */
    public List<CatNormasConstruccionTipo> getListNormaTipo() {
        return normasServices.getCatNormasConstruccionTipo(normaTipo);
    }

    public void normaSelecionada() {
        normaConstruccion.setTipoNorma(new CatNormasConstruccionTipo(idTipoNorma));
    }
    ...
    public NormasConstruccion() {
    }

    public Long getTipoNorma() {
        return tipoNorma;
    }

    public void setTipoNorma(Long tipoNorma) {
        this.tipoNorma = tipoNorma;
    }

    public Long getIdCiudadela() {
        return idCiudadela;
    }

    public void setIdCiudadela(Long idCiudadela) {
    ...
    public Long getIdTipoNorma() {
        return idTipoNorma;
    }

    public void setIdTipoNorma(Long idTipoNorma) {
        this.idTipoNorma = idTipoNorma;
    }

    public Boolean getNormaTipo() {
        return normaTipo;
    }

    public void setNormaTipo(Boolean normaTipo) {
        this.normaTipo = normaTipo;
    }
    ...
    public void setEsProceso(Boolean esProceso) {
