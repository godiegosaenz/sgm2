 ...
 * @author Anyelo
 */
@WebServlet(name = "AcuerdoIngreso", urlPatterns = {"/AcuerdoIngreso"})
public class AcuerdoIngreso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File reportFile = new File(getServletConfig().getServletContext()
                    .getRealPath("/reportes/registroPropiedad/acuerdoInscripcionRp.jasper"));
