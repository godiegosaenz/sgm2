 ...
 * @author Anyelo
 */
@WebServlet(name = "PreformaIngreso", urlPatterns = {"/PreformaIngreso"})
public class PreformaIngreso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File reportFile = new File(getServletConfig().getServletContext()
                    .getRealPath("/reportes/registroPropiedad/ReportePreforma.jasper"));
